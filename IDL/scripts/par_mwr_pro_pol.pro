...
set_lwp_off = 1
lwp_std_thres = 1.5
;lwp_std_thres = 0.9 ;for 10, 11, and 12.07.2020
...
user_range_max = [-999., 600., -999., -999., -999., 100.] 
...
contact_person = 'Ronny Engelmann (ronny.engelmann@tropos.de)'
author = 'Ulrich Loehnert (loehnert@meteo.uni-koeln.de)'
source = 'RPG HATPRO G5 microwave radiometer'
history = 'Data processed with mwrpro-v04 by University of Cologne (Kerstin Ebell, kebell@meteo.uni-koeln.de); '
conventions = 'CF-1.6'
