...
;OR internal (testing) version (i.e., i03)
vnn_l1b = 'v00'
vnn_l1c = 'v00'
vnn_l2a_iwv = 'v00'
vnn_l2a_lwp = 'v00'
...
;algo_iwv='nya_rt06'				; Ny Alesund Radiosondes, simulated TBs at MiRAC-P frequencies
;algo_iwv='pol_rt07'				; ECMWF ERA-Interim reanalysis 2001-2019, stations selected by Emiliano Orlandi (RPG),
						; TBs at MiRAC-P frequencies; adapted by Andreas Walbroel to run on IDL tools
;algo_iwv='nya_rt08'                            ; Ny Alesund Radiosondes, simulated TBs at MiRAC-P frequencies (like i03, or nya_rt06), but for 
                                                ; cubic regression
;algo_iwv='pol_rt09'				; ECMWF ERA-Interim reanalysis like pol_rt07, but with cubic regression terms
;algo_lwp='nya_rt00'
...
;tb_offset_file = 'tb_offset_pol.sav'
...
;offset_tb_type = 'Polarstern radiosondes'
...
source = 'RPG_LHUMPRO microwave radiometer MIRAC-P'
