...
;KEYWORDS
verbose = verbose,$
angle_calc = angle_calc     ;default is 0, 1 means calculate angles in old manner (see below), only necessary for BRT files with file codes 666666
; Abstract:
...
IF code NE 666666 AND code NE 666000 THEN BEGIN 
...
x2 = 0b
help = FLTARR(n_f)
IF code EQ 666666 THEN x = 0.
IF code EQ 666000 THEN x = 0l
