...
IF rets(6) NE '-' THEN BEGIN
 ...
 dep_l1 = fn_l1c.kkk + '_' + fn_l1c.sss + '_' + fn_l1c.inst + fn_l1c.instnn + '_'+ fn_l1c.lll1 + '_' + fn_l1c.var + '_' + fn_l1c.vnn
...
;*****define variables & attributes
 ...
 NCDF_ATTPUT, outfid_tel, flaid, 'flag_meanings', "visual_inspection_filter_band_1 visual_inspection_filter_band2 visual_inspection_filter_band3 rain_flag sanity_receiver_band1 sanity_receiver_band2 sun_in_beam tb_threshold_band1 tb_threshold_band2 tb_threshold_band3 iwv_lwp_threshold temperature_threshold"
...
;****global attributes
 ...
 NCDF_ATTPUT, outfid_tel, /GLOBAL, 'Comments', ga.co
 NCDF_ATTPUT, outfid_tel, /GLOBAL, 'Licence', ga.l
