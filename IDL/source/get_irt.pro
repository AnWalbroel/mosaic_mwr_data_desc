...
; Changes:
; 2018-02-26 (UL)
; changed to be able to handle new RPG angle format (file code 671112000) 
; XXXX-XX-XX:
; changed program ...
;-
...
code=1l
READU,unit,code
IF code NE 671112496 AND code NE 671112495 AND code NE 671112000 THEN PRINT,'Error in IRT file code'

IF code EQ 671112496 OR code EQ 671112000 THEN ir_type = 'kt2'
...
IF code EQ 671112000 THEN ang_irt = -999l
IF code GT 671112000 THEN ang_irt = -999.
...
FOR i = 0l,LONG(n-1l) DO BEGIN
  ...
  IF code GT 671112000 THEN BEGIN
   sign = 1
   ...
   ENDIF
  ENDIF ELSE BEGIN
   c = STRCOMPRESS(ang_irt, /REMOVE_ALL)
