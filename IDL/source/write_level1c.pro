...
tb_bias_estimate,$              ;3D TB array of TB offset if specified
tb_bias_estimate_type,$         ;CHARACTER defining source for offset correction
...
tbocrid = NCDF_VARDEF(outfid, 'tb_bias_estimate',[fredid,angdid,timdid], /float)
...
tbiid = NCDF_VARDEF(outfid, 'tb_absolute_accuracy',[fredid], /float)
...
NCDF_VARPUT, outfid, tbocrid, tb_bias_estimate
NCDF_VARPUT, outfid, fsrid, freq_shift
NCDF_VARPUT, outfid, tbiid, tb_absolute_accuracy
